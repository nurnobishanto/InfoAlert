...
public class AppRelatedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("App Related Complain");
    ...
    private void AddPost(String url) {
        ProgressDialog dialog = new ProgressDialog(AppRelatedActivity.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Constant.ADD_COMPLAIN, response ->{
            ...
            try {
                ...
                if(object.getBoolean("status")){
                    Toast.makeText(AppRelatedActivity.this,object.getString("message"),Toast.LENGTH_LONG).show();
                    finish();
                }
                else {
                    Toast.makeText(AppRelatedActivity.this,object.getString("message"),Toast.LENGTH_LONG).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(AppRelatedActivity.this);
        queue.add(request);
    }
    ...
    public void UploadImage() {
        ...
        if (postimageUri != null) {
            ...
            final ProgressDialog pd = new ProgressDialog(AppRelatedActivity.this);
